            ...
            <div className="price-block">
              ...
              <div className="price-body">
                <ul className="price-features">
                  ...
                  <li className="price-list">
                    They are the perfect starting point for first-time wearers
                    of eyelash extensions and are most popular for everyday wear
                  </li>
                  <li className="price-list">
            ...
            <div className="price-block">
              ...
              <div className="price-body">
                <ul className="price-features">
                  ...
                  <li className="price-list">
                    {" "}
                    Most clients get a 'fill' every 2-3 weeks. With proper home
                    care, you should expect to have at least half of your
                    extensions at 3 weeks.
                  </li>
                  <li className="price-list">
                    <Link to="/book-appointment" className="price-button">
                      Book Appointment
